...
//    TextView mcountry;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        cusheader.setVisibility(View.GONE);
...
//                call APi with this constructor
    ...
    private void load_mx_stateSPinner() {
        ...
        ArrayAdapter<StatesPOJO> madapter = new ArrayAdapter<StatesPOJO>(UpdateCityBinsActivity.this,
    ...
    private void load_us_stateSPinner() {
        ...
        ArrayAdapter<StatesPOJO> uadapter = new ArrayAdapter<StatesPOJO>(UpdateCityBinsActivity.this,
                android.R.layout.simple_spinner_item, stateList);
    ...
    private void load_ca_stateSPinner() {
        ...
        ArrayAdapter<StatesPOJO> cadapter = new ArrayAdapter<StatesPOJO>(UpdateCityBinsActivity.this,
                android.R.layout.simple_spinner_item, stateList);
    ...
    private void loadCountrySpinner() {
        ...
        ArrayAdapter<Country> adapter = new ArrayAdapter<Country>(UpdateCityBinsActivity.this,
