...
public class FieldOffice_fragment extends Fragment {

    D_OfficeAdapter padapter;
    RecyclerView mrecycleView;
    List<OfficeOrder> UList = new ArrayList<>();
    Context mContext;
    TextView nulldisplay;
    String from1,to1;


    public FieldOffice_fragment() {
    }
...
//        return view;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        padapter = new D_OfficeAdapter(UList, getContext());
    ...
    private void loadAdapter() {
        ...
        if (getArguments() != null) {
            ...
            ArrayList<OfficeOrder> logs1 = getArguments().getParcelableArrayList("WeekOfficeList");
