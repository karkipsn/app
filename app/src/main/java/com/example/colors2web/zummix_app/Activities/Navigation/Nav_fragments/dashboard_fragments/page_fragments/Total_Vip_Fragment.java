...
public class Total_Vip_Fragment extends Fragment {

    D_TotalVipAdapter padapter;
    RecyclerView mrecycleView;
    List<TotalVipOrder> UList = new ArrayList<>();
    Context mContext;
    TextView nulldisplay;
    String from1,to1;


    public Total_Vip_Fragment() {
    }
...
//        return view;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        padapter = new D_TotalVipAdapter(UList, getContext());
    ...
    private void loadAdapter() {
        ...
        if (getArguments() != null) {
            ...
            ArrayList<TotalVipOrder> logs1 = getArguments().getParcelableArrayList("WeekTotalVipList");
