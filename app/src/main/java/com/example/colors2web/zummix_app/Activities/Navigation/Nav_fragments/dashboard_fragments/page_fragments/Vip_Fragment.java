...
public class Vip_Fragment extends Fragment {
    ...
    D_VipAdapter padapter;
    RecyclerView mrecycleView;
    List<VipOrder> UList = new ArrayList<>();
    Context mContext;
...
//        return view;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        padapter = new D_VipAdapter(UList, getContext());
    ...
    private void loadAdapter() {
        ...
        if (getArguments() != null) {
            ...
            ArrayList<VipOrder> logs1 = getArguments().getParcelableArrayList("WeekVipList");
