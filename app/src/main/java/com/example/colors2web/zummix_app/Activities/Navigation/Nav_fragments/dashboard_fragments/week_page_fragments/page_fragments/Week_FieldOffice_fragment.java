...
import com.example.colors2web.zummix_app.Adapter.DashboardAdapters.D_OfficeAdapter;
import com.example.colors2web.zummix_app.Adapter.WeekDashboardAdapters.DashboardAdapters.WD_OfficeAdapter;
...
public class Week_FieldOffice_fragment extends Fragment {

    WD_OfficeAdapter padapter;
    RecyclerView mrecycleView;
    List<WeekOfficeOrder> UList = new ArrayList<>();
    Context mContext;
    TextView nulldisplay;
    String from1,to1;


    public Week_FieldOffice_fragment() {
    }
...
//        return view;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        padapter = new WD_OfficeAdapter(UList, getContext());
    ...
    private void loadAdapter() {
        ...
        if (getArguments() != null) {
            ...
            ArrayList<WeekOfficeOrder> logs1 = getArguments().getParcelableArrayList("WeekOfficeList");
