...
import com.example.colors2web.zummix_app.Adapter.WeekDashboardAdapters.DashboardAdapters.WD_ShipToAdapter;
...
public class Week_ShipTo_Fragment extends Fragment {

    WD_ShipToAdapter padapter;
    RecyclerView mrecycleView;
    List<WeekShipToOrder> UList = new ArrayList<>();
    Context mContext;
    TextView nulldisplay;
    String from1, to1;


    public Week_ShipTo_Fragment() {
    }
...
//        return view;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        padapter = new WD_ShipToAdapter(UList, getContext());
    ...
    private void loadAdapter() {
        ...
        if (getArguments() != null) {
            ...
            ArrayList<WeekShipToOrder> logs1 = getArguments().getParcelableArrayList("WeekShipTOList");
