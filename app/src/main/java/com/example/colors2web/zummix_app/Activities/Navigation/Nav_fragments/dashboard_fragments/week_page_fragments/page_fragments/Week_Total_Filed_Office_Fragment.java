...
import com.example.colors2web.zummix_app.Adapter.WeekDashboardAdapters.DashboardAdapters.WD_TotalOfficeAdapter;
...
public class Week_Total_Filed_Office_Fragment extends Fragment {

    WD_TotalOfficeAdapter padapter;
    RecyclerView mrecycleView;
    List<WeekTotalOfficeOrder> UList = new ArrayList<>();
    Context mContext;
    TextView nulldisplay;
    String from1,to1;


    public Week_Total_Filed_Office_Fragment() {
    }
...
//        return view;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        padapter = new WD_TotalOfficeAdapter(UList, getContext());
    ...
    private void loadAdapter() {
        ...
        if (getArguments() != null) {
            ...
            ArrayList<WeekTotalOfficeOrder> logs1 = getArguments().getParcelableArrayList("WeekTotalOfficeList");
