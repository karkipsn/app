...
import com.example.colors2web.zummix_app.Adapter.WeekDashboardAdapters.DashboardAdapters.WD_Total_ShipToAdapter;
...
public class Week_Total_Ship_To_Fragment extends Fragment {
    WD_Total_ShipToAdapter padapter;
    RecyclerView mrecycleView;
    List<WeekTotalShipToOrder> UList = new ArrayList<>();
    Context mContext;
    TextView nulldisplay;
    String from1,to1;


    public Week_Total_Ship_To_Fragment() {
    }
...
//        return view;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        padapter = new WD_Total_ShipToAdapter(UList, getContext());
    ...
    private void loadAdapter() {
        ...
        if (getArguments() != null) {
            ...
            ArrayList<WeekTotalShipToOrder> logs1 = getArguments().getParcelableArrayList("WeekTotalShipTOList");
