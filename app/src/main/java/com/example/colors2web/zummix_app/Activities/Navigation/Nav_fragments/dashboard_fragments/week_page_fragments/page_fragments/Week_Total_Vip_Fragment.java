...
import com.example.colors2web.zummix_app.Adapter.DashboardAdapters.D_TotalVipAdapter;
import com.example.colors2web.zummix_app.Adapter.WeekDashboardAdapters.DashboardAdapters.WD_TotalVipAdapter;
...
public class Week_Total_Vip_Fragment extends Fragment {

    WD_TotalVipAdapter padapter;
    RecyclerView mrecycleView;
    List<WeekTotalVipOrder> UList = new ArrayList<>();
    Context mContext;
    TextView nulldisplay;
    String from1,to1;


    public Week_Total_Vip_Fragment() {
    }
...
//        return view;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        padapter = new WD_TotalVipAdapter(UList, getContext());
    ...
    private void loadAdapter() {
        ...
        if (getArguments() != null) {
            ...
            ArrayList<WeekTotalVipOrder> logs1 = getArguments().getParcelableArrayList("WeekTotalVipList");
