...
public class Item_Sales_HistoryActivity extends AppCompatActivity {
    ...
    @BindView(R.id.item_sales_sku)
    TextView msku;

    @BindView(R.id.item_sales_from)
    TextView mform;

    @BindView(R.id.item_sales_to)
    TextView mto;

    @BindView(R.id.btn_item_sales_submit)
    Button btn_submit;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_item_sales_history);
        ...
        mform.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Item_Sales_HistoryActivity.this,
...
//        });
    ...
    private void call_item_dr_history(String email, String password, String item_sku, Long customer,
        ...
        if (customer != null) {
            ...
            final ProgressDialog progressDialog = new ProgressDialog(com.example.colors2web.zummix_app.Activities.PostActivity.Item_Sales_HistoryActivity.this,
            ...
            call.enqueue(new Callback<PostResponse>() {
                             ...
                             public void onResponse(Call<PostResponse> call, Response<PostResponse> response) {
                                 if (response.isSuccessful()) {
                                     ...
                                     if (shipments != null) {
                                         ...
                                         Intent intent = new Intent(Item_Sales_HistoryActivity.this,View_salesHistoryActivity.class);
                                     ...
                                     Toast.makeText(com.example.colors2web.zummix_app.Activities.PostActivity.Item_Sales_HistoryActivity.this, "Operation Failed", Toast.LENGTH_SHORT).show();
                             ...
                             public void onFailure(Call<PostResponse> call, Throwable t) {
                                 ...
                                 Toast.makeText(com.example.colors2web.zummix_app.Activities.PostActivity.Item_Sales_HistoryActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                                 if (progressDialog.isShowing()) {
                                     progressDialog.dismiss();
                                 }
...
//                            spin_value.add(cus_id);
                        ...
                        mspinner.setAdapter(new ArrayAdapter<SpinnerPojo>(com.example.colors2web.zummix_app.Activities.PostActivity.Item_Sales_HistoryActivity.this,
