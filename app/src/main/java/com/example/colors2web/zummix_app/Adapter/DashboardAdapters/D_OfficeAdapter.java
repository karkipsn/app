...
public class D_OfficeAdapter extends RecyclerView.Adapter<D_OfficeAdapter.OHolder> {

    List<OfficeOrder> OfficeList;
    Context mContext;
    private String from, to, order_status;
    private String order_type = "0";

    public D_OfficeAdapter(List<OfficeOrder> officeList, Context mContext) {
    ...
    @NonNull
    @Override
    public D_OfficeAdapter.OHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull D_OfficeAdapter.OHolder holder, int position) {
        OfficeOrder ship = OfficeList.get(position);
...
//        holder.ior.setText(String.valueOf(ship.getmTotalIor()));
    ...
    public void updateAnswers(ArrayList<OfficeOrder> logs1, String from1, String to1) {
