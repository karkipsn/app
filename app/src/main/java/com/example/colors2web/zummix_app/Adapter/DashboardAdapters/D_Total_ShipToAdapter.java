...
public class D_Total_ShipToAdapter extends RecyclerView.Adapter<D_Total_ShipToAdapter.TotalHolder> {

    List<TotalShipToOrder>WeekShipList;
    Context mContext;
    private String order_type = "1";
    private String customer_id ="all";
    private String from,to,order_status ;

    public D_Total_ShipToAdapter(List<TotalShipToOrder> weekShipList, Context mContext) {
    ...
    @NonNull
    @Override
    public D_Total_ShipToAdapter.TotalHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull D_Total_ShipToAdapter.TotalHolder holder, int position) {

        TotalShipToOrder ship = WeekShipList.get(position);
...
//        holder.ior.setText(String.valueOf(ship.getmTotalIor()));
    ...
    public void updateAnswers(ArrayList<TotalShipToOrder> logs1, String from1, String to1) {
