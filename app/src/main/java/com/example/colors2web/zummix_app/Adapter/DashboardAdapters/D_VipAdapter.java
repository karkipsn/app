...
public class D_VipAdapter extends RecyclerView.Adapter<D_VipAdapter.VipHolderc> {

    List<VipOrder>VipList;
    Context mContext;
    private String from, to, order_status;
    private String order_type = "2";

    public D_VipAdapter(List<VipOrder> vipList, Context mContext) {
        VipList = vipList;
    ...
    @NonNull
    @Override
    public D_VipAdapter.VipHolderc onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull D_VipAdapter.VipHolderc holder, int position) {

        VipOrder ship = VipList.get(position);
    ...
    public void updateAnswers(ArrayList<VipOrder> logs1, String from1, String to1) {
        VipList.clear();
        VipList=logs1;
        from =from1;
        to=to1;
