...
public class WD_TotalOfficeAdapter extends RecyclerView.Adapter<WD_TotalOfficeAdapter.OfficeHolder> {

    List<WeekTotalOfficeOrder>WTOList;
    Context mContext;
    private String order_type = "0";
    private String customer_id ="all";
    private String from,to,order_status ;

    public WD_TotalOfficeAdapter(List<WeekTotalOfficeOrder> WTOList, Context mContext) {
    ...
    @NonNull
    @Override
    public WD_TotalOfficeAdapter.OfficeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull WD_TotalOfficeAdapter.OfficeHolder holder, int position) {

        WeekTotalOfficeOrder ship = WTOList.get(position);
...
//        holder.ior.setText(String.valueOf(ship.getmTotalIor()));
    ...
    public void updateAnswers(ArrayList<WeekTotalOfficeOrder> logs1, String from1, String to1) {
        WTOList =logs1;
        from = from1;
        to = to1;
