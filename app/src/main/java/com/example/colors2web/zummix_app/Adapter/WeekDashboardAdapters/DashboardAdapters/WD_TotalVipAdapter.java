...
public class WD_TotalVipAdapter extends RecyclerView.Adapter<WD_TotalVipAdapter.VHolder> {
    private List<WeekTotalVipOrder> WVList;
    private Context mContext;
    private String order_type = "2";
    private String customer_id = "all";
    private String from, to, order_status;

    public WD_TotalVipAdapter(List<WeekTotalVipOrder> WVList, Context mContext) {
        this.WVList = WVList;
    ...
    public void onBindViewHolder(@NonNull VHolder holder, int position) {
        ...
        WeekTotalVipOrder ship = WVList.get(position);
...
//        holder.ior.setText(String.valueOf(ship.getmTotalIor()));
    ...
    public void updateAnswers(ArrayList<WeekTotalVipOrder> logs1, String from1, String to1) {
        WVList = logs1;
        from = from1;
        to = to1;
