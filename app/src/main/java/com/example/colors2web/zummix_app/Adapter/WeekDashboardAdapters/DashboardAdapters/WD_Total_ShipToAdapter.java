...
public class WD_Total_ShipToAdapter extends RecyclerView.Adapter<WD_Total_ShipToAdapter.TotalHolder> {

    List<WeekTotalShipToOrder>WeekShipList;
    Context mContext;
    private String order_type = "1";
    private String customer_id ="all";
    private String from,to,order_status ;

    public WD_Total_ShipToAdapter(List<WeekTotalShipToOrder> weekShipList, Context mContext) {
        WeekShipList = weekShipList;
        this.mContext = mContext;
    }

    @NonNull
    @Override
    public WD_Total_ShipToAdapter.TotalHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull WD_Total_ShipToAdapter.TotalHolder holder, int position) {

        WeekTotalShipToOrder ship = WeekShipList.get(position);
...
//        holder.ior.setText(String.valueOf(ship.getmTotalIor()));
    ...
    public int getItemCount() {
        return WeekShipList.size();
    }

    public void updateAnswers(ArrayList<WeekTotalShipToOrder> logs1, String from1, String to1) {
        WeekShipList =logs1;
        from =from1;
        to =to1;
