...
public class WD_VipAdapter extends RecyclerView.Adapter<WD_VipAdapter.VipHolderc> {

    List<WeekVipOrder>VipList;
    Context mContext;
    private String from, to, order_status;
    private String order_type = "2";

    public WD_VipAdapter(List<WeekVipOrder> vipList, Context mContext) {
        VipList = vipList;
    ...
    @NonNull
    @Override
    public WD_VipAdapter.VipHolderc onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).
                inflate(R.layout.activity_dashboard_adapter,parent,false);

        return new VipHolderc(view);
    }

    @Override
    public void onBindViewHolder(@NonNull WD_VipAdapter.VipHolderc holder, int position) {

        WeekVipOrder ship = VipList.get(position);
    ...
    public void updateAnswers(ArrayList<WeekVipOrder> logs1, String from1, String to1) {
        VipList=logs1;
        from =from1;
        to=to1;
    ...
    public class VipHolderc extends RecyclerView.ViewHolder {
        TextView customer,total,tover,pending,pover,batch,bover,shipped,ior;

        public VipHolderc(View itemView) {
            super(itemView);
