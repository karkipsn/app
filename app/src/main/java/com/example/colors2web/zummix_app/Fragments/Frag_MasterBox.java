...
import com.example.colors2web.zummix_app.Adapter.BoxAdapters.MasterBoxAdapter;
...
public class Frag_MasterBox extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        radapter = new MasterBoxAdapter(getActivity(),MList);
...
//        mrecyclerView.addItemDecoration(new SimpleItemDecoration(getContext()));
    ...
    private void loadAdapter() {
        if (getArguments() != null) {
            ...
            ArrayList<MasterBox> barraylist = getArguments().getParcelableArrayList("masterbox_detail");
