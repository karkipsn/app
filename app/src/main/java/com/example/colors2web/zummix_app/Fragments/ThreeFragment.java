...
//        OrderLog log = new OrderLog("Mad Max: Fury Road", (long) 4);
//        LogList.add(log);
            ...
            public void onResponse(Call<Order2Response> call, Response<Order2Response> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (order != null) {
                        ...
                        List<OrderLog> deps = dep.getOrderDetails().getOrderLogs();

                        for (int i = 0; i < deps.size(); i++) {

                            OrderLog dis = new OrderLog();

                            String ord_no = deps.get(i).getOrderNumber();
                            String ord_status = deps.get(i).getOrderStatus();
                            String event_by = deps.get(i).getEventBy();
                            String event_at = deps.get(i).getUpdatedAt();

                            dis.setOrderNumber( ord_no);
                            dis.setOrderStatus( ord_status);
                            dis.setUpdatedAt( event_at);
                            dis.setEventBy( event_by);

                            LogList.add(dis); // must be the object of empty list initiated
                        }

                        radapter.updateAnswers(LogList);//adapter's content is updated and update function is called;
...
//
//                                case "7":
//                                    dis.setOrderStatus( " Edited Shipping Address");
//                                    break;
//
//                                    case "6":
//                                    dis.setOrderStatus( " Shipped");
//
//                                    break;
//
//                                    case "5":
//                                    dis.setOrderStatus( "IOR");
//                                    break;
//
//                                case "4":
//                                    String s = "Packed";
//                                    dis.setOrderStatus( s);
//                                    break;
//
//                                case "3":
//                                    dis.setOrderStatus( " Picked");
//                                    break;
//
//                                case "2":
//                                    dis.setOrderStatus( " Batch Created");
//                                    break;
//
//                                case "1":
//                                    dis.setOrderStatus( "Cancelled");
//                                    break;
//
//                                case "0":
//                                    dis.setOrderStatus( "Order Created");
//                                    break;
//
//                                case "8":
//                                    dis.setOrderStatus( "Pick List Printed");
//                                    break;
//
//                                case "9":
//                                    dis.setOrderStatus( " Cancelled Shipment");
//                                    break;
//
//                                case "10":
//                                    dis.setOrderStatus( "Pick Started");
//                                    break;
//
//                                case "11":
//                                    dis.setOrderStatus( "Pick Ended");
//                                    break;
//
//                                case "12":
//                                    dis.setOrderStatus( "Pack Started");
//                                    break;
//
//                                case "13":
//                                    dis.setOrderStatus( " Pack Ended");
//                                    break;
//                            }
