...
public class TotalShipToOrder implements Parcelable {
    ...
    protected TotalShipToOrder(Parcel in) {
        if (in.readByte() == 0) {
            mNoOfOrders = null;
        } else {
    ...
    public static final Creator<TotalShipToOrder> CREATOR = new Creator<TotalShipToOrder>() {
        @Override
        public TotalShipToOrder createFromParcel(Parcel in) {
            return new TotalShipToOrder(in);
        }

        @Override
        public TotalShipToOrder[] newArray(int size) {
            return new TotalShipToOrder[size];
        }
    };
