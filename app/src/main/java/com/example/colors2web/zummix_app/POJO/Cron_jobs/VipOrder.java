...
public class VipOrder implements Parcelable {
    ...
    public static final Creator<VipOrder> CREATOR = new Creator<VipOrder>() {
        @Override
        public VipOrder createFromParcel(Parcel in) {
            return new VipOrder(in);
        }

        @Override
        public VipOrder[] newArray(int size) {
            return new VipOrder[size];
        }
    };
