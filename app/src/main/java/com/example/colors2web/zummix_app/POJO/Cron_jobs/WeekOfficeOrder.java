...
public class WeekOfficeOrder implements Parcelable {
    ...
    public WeekOfficeOrder() {
    }

    protected WeekOfficeOrder(Parcel in) {
        if (in.readByte() == 0) {
            mCustomerId = null;
        } else {
    ...
    public static final Creator<WeekOfficeOrder> CREATOR = new Creator<WeekOfficeOrder>() {
        @Override
        public WeekOfficeOrder createFromParcel(Parcel in) {
            return new WeekOfficeOrder(in);
        }

        @Override
        public WeekOfficeOrder[] newArray(int size) {
            return new WeekOfficeOrder[size];
        }
    };
