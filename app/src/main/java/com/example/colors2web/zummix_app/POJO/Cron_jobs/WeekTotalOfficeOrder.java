...
public class WeekTotalOfficeOrder implements Parcelable {
    ...
    public WeekTotalOfficeOrder() {
    }

    protected WeekTotalOfficeOrder(Parcel in) {
        if (in.readByte() == 0) {
            mNoOfOrders = null;
        } else {
    ...
    public static final Creator<WeekTotalOfficeOrder> CREATOR = new Creator<WeekTotalOfficeOrder>() {
        @Override
        public WeekTotalOfficeOrder createFromParcel(Parcel in) {
            return new WeekTotalOfficeOrder(in);
        }

        @Override
        public WeekTotalOfficeOrder[] newArray(int size) {
            return new WeekTotalOfficeOrder[size];
        }
    };
