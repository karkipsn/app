...
public class WeekTotalVipOrder implements Parcelable {

    public WeekTotalVipOrder() {
    }
    ...
    protected WeekTotalVipOrder(Parcel in) {
        if (in.readByte() == 0) {
            mNoOfOrders = null;
        } else {
    ...
    public static final Creator<WeekTotalVipOrder> CREATOR = new Creator<WeekTotalVipOrder>() {
        @Override
        public WeekTotalVipOrder createFromParcel(Parcel in) {
            return new WeekTotalVipOrder(in);
        }

        @Override
        public WeekTotalVipOrder[] newArray(int size) {
            return new WeekTotalVipOrder[size];
        }
    };
