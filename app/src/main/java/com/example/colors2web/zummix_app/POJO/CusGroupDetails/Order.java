...
public class Order {
    ...
    private String mTotalPieces;
    @SerializedName("totalUniqueItems")
    private Long mTotalUniqueItems;
    ...
    public Long getTotalUniqueItems() {
        return mTotalUniqueItems;
    }

    public void setTotalUniqueItems(Long totalUniqueItems) {
        mTotalUniqueItems = totalUniqueItems;
    }
