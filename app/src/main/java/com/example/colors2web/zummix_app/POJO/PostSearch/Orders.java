...
public class Orders implements Serializable {
    ...
    private String mRefundedQuantity;
    ...
    @SerializedName("tag")
    private String mTag;
    @SerializedName("unbox_total")
    private Long mUnboxTotal;
    ...
    public String getRefundedQuantity() {
        return mRefundedQuantity;
    }

    public void setRefundedQuantity(String refundedQuantity) {
        mRefundedQuantity = refundedQuantity;
    }
    ...
    public Long getUnboxTotal() {
        return mUnboxTotal;
    }

    public void setUnboxTotal(Long unboxTotal) {
        mUnboxTotal = unboxTotal;
    }
