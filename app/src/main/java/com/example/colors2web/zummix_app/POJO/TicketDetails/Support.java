...
public class Support implements Serializable {
    ...
    private String mEscalateToCorporate;
    @SerializedName("id")
    private Long mId;
    ...
    public String getEscalateToCorporate() {
        return mEscalateToCorporate;
    }

    public void setEscalateToCorporate(String escalateToCorporate) {
        mEscalateToCorporate = escalateToCorporate;
    }
